...
The production homepage uses the action-first Living Resume design. `/homepage-preview`
remains a `noindex` review mirror of that experience: one primary action, a three-step default

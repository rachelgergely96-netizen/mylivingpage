              ...
              <div className="mt-2 flex flex-wrap items-center gap-2 sm:gap-3">
                {data.email ? (
                  disableExternalLinks ? (
                    <span className="flex items-center gap-1.5 py-1 text-[10px] sm:text-xs text-[rgba(240,244,255,0.5)]">
                ...
                {data.linkedin ? (
                  disableExternalLinks ? (
                    <span title="LinkedIn" aria-label="LinkedIn profile" className="flex items-center justify-center rounded-md p-1 text-[rgba(240,244,255,0.5)]">

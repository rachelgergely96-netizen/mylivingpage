...
export default function MockPageContent({ isPro, viewMode }: MockPageContentProps) {
  ...
  return (
    <div className="relative z-10 overflow-hidden px-4 py-5 sm:p-6">
      ...
      {/* Name */}
      <h3
        className="mb-2 font-heading font-light text-[#F0F4FF] transition-all duration-400"
      ...
      {/* Bio */}
      <p className="mb-4 max-w-md text-sm font-light leading-relaxed text-[rgba(240,244,255,0.78)] transition-all duration-500">
      ...
      <div className="mb-4">
        ...
        <div className="rounded-xl border border-[rgba(255,255,255,0.08)] bg-gradient-to-br from-[rgba(255,255,255,0.03)] to-[rgba(15,25,50,0.3)] p-4">

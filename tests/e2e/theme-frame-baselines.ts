...
export const THEME_FRAME_BASELINES = {
  ...
  fluid: { hash: "070927234f494b53", mean: [10, 29, 39] },
  ...
  dusk: { hash: "070347069d070603", mean: [39, 18, 24] },
  matrix: { hash: "0305010303010305", mean: [3, 12, 6] },
  coral: { hash: "0b0b070b0dae179b", mean: [28, 27, 30] },
  stardust: { hash: "0101010101010101", mean: [21, 19, 39] },
  ink: { hash: "5313050244030303", mean: [10, 13, 20] },
  bloom: { hash: "070327070f2f0501", mean: [53, 28, 60] },
  silk: { hash: "2f8b4b8d2d2f259b", mean: [13, 12, 26] },
  ...
  vault: { hash: "0f2b2b0f8f0f0f0f", mean: [18, 24, 37] },
  opaline: { hash: "274545c54b5b4c87", mean: [22, 24, 40] },
  halo: { hash: "0303020201010111", mean: [16, 9, 12] },
  sonata: { hash: "0f0f0f4fa9696901", mean: [28, 14, 25] },
  mosaic: { hash: "0304020202030706", mean: [12, 20, 29] },
  bastion: { hash: "0101000001030303", mean: [18, 22, 26] },
  carbon: { hash: "0509450909410a55", mean: [31, 37, 46] },
  caliber: { hash: "07170f0f0f0d0f0b", mean: [8, 12, 22] },
  harbor: { hash: "531d038f03a28f52", mean: [11, 20, 27] },
  relay: { hash: "2131313733911729", mean: [7, 19, 25] },
  meridian: { hash: "0103030301010103", mean: [6, 12, 17] },
  ...
  vellum: { hash: "8381010101010313", mean: [30, 28, 31] },
  lustre: { hash: "0100010001040801", mean: [34, 25, 20] },
  fresco: { hash: "23232b2323032325", mean: [41, 35, 29] },
  rosaline: { hash: "0101030101038101", mean: [46, 25, 38] },
